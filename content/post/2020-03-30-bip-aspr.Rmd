...
I have a new book in progress called *A Short Introduction to Applied Statistical Programming in R*, which can be viewed online as a Gitbook (https://rs-aspr.netlify.com/) or as a PDF (https://github.com/robertschnitman/aspr/blob/master/aspr.pdf). [**EDIT 2020-04-01:** I will primarily focus on the Gitbook version, as I am running into some typesetting issues with the PDF at the moment.]
